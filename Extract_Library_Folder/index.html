  ...
  <body>
    ...
    <div class="contents" id="spprtd">
      ...
      <div id="app" class="card">
        ...
        <h1 class="neons">Extract Library Folder </h1>
        <form name="page-designer-library" id="form-pd">
          ...
          <div>
            <label for="pageids-textarea">Library Folder IDs (comma separated values):</label>
            <textarea name="pageids" id="pageids-textarea" placeholder="library-folder-id, library-folder2-id, library-folder3-id" required></textarea>
          </div>
    ...
    <!--END OF CONTENT-->
        ...
        <!-- END OF BACK GROUND-->
        <script src="js/library-folder-extract.js"></script>
